...
(function($) {
   ...
   ------------------------------------------------------ */  
	...
	setTimeout(function() {
   	...
   	$('h1.page-responsive-headline').fitText(1.2, { minFontSize: '35px', maxFontSize: '50px' });
   ...
   ------------------------------------------------------ */
  	...
  	$('.js #subscribe').waypoint(function() {
   	$('.js #subscribe input[type="email"]').addClass( 'animated fadeInLeftBig show' ); 
		$('.js #subscribe input[type="text"]').addClass( 'animated fadeInLeftBig show' ); 
		$('.js #subscribe textarea').addClass( 'animated fadeInLeftBig show' ); 
